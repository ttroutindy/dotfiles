...
class OpenWeatherMap(BaseClass):
    ...
    def poll(self):
        ...
        if resp.status_code == 200:
            ...
            wind_units = {"metric": "m/s", "imperial": "mph" } [ self.units ]
            ...
            info = {
                ...
                "wind_speed": _lookup(data["wind"], "speed"),
                "wind_direction": degrees_to_cardinal(_lookup(data["wind"], "deg")),
                "wind_gusts": _lookup(["wind"], "gust"),
